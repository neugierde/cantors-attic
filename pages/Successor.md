...
(Redirected from
[Successor](/web/20191005051206/http://cantorsattic.info/index.php?title=Successor&redirect=no "Successor"))
...
principle](/web/20191005051206/http://cantorsattic.info/Well-ordering_principle "Well-ordering principle"),
which asserts that every set can be well-ordered and therefore admits a
bijection with a unique smallest
[ordinal](/web/20191005051206/http://cantorsattic.info/Ordinal "Ordinal"),
...
The set
[\$\\omega\$](/web/20191005051206/http://cantorsattic.info/Omega "Omega")
of [natural
numbers](/web/20191005051206/http://cantorsattic.info/Omega "Omega") is
...
ordinal](/web/20191005051206/http://cantorsattic.info/Successor_ordinal "Successor ordinal")
...
as the [Dedekind
finite](/web/20191005051206/http://cantorsattic.info/Dedekind_finite "Dedekind finite")
sets, but in ZF, these concepts may differ. In ZFC,
[\$\\aleph\$](/web/20191005051206/http://cantorsattic.info/Aleph "Aleph")
is a unique
[order-isomorphism](/web/20191005051206/http://cantorsattic.info/Order-isomorphism "Order-isomorphism")
...
[uncountable](/web/20191005051206/http://cantorsattic.info/Uncountable "Uncountable"){.mw-redirect}
...
known as the **[Hartog
number](/web/20191005051206/http://cantorsattic.info/Hartog_number "Hartog number")**
...
leads to the [aleph
hierarchy](/web/20191005051206/http://cantorsattic.info/Aleph "Aleph").
...
inaccessible](/web/20191005051206/http://cantorsattic.info/Inaccessible "Inaccessible")
...
The [axiom of
choice](/web/20191005051206/http://cantorsattic.info/Axiom_of_choice "Axiom of choice"){.mw-redirect}
...
See [general
cardinal](/web/20191005051206/http://cantorsattic.info/Cardinal_general "Cardinal general")
...
Retrieved from
"[http://cantorsattic.info/index.php?title=Cardinal&oldid=2475\#successor\_cardinals](http://web.archive.org/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&oldid=2475#successor_cardinals)"
...
-   <div id="pt-createaccount">
    ...
    [Create
    account](/web/20191005051206/http://cantorsattic.info/index.php?title=Special:UserLogin&returnto=Cardinal&type=signup)
-   <div id="pt-login">

    </div>

    [Log
    in](/web/20191005051206/http://cantorsattic.info/index.php?title=Special:UserLogin&returnto=Cardinal "You are encouraged to log in; however, it is not mandatory [o]")
...
-   <div id="ca-nstab-main">
    ...
    [[Page](/web/20191005051206/http://cantorsattic.info/Cardinal "View the content page [c]")]{}
-   <div id="ca-talk">

    </div>

    [[Discussion](/web/20191005051206/http://cantorsattic.info/index.php?title=Talk:Cardinal&action=edit&redlink=1 "Discussion about the content page [t]")]{}
...
-   <div id="ca-view">
    ...
    [[Read](/web/20191005051206/http://cantorsattic.info/Cardinal)]{}
-   <div id="ca-viewsource">

    </div>

    [[View
    source](/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&action=edit "This page is protected.
...
-   <div id="ca-history">
    ...
    [[View
    history](/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&action=history "Past revisions of this page [h]")]{}
...
[](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic "Visit the main page")
...
-   <div id="n-Upper-attic">
    ...
    [Upper
    attic](/web/20191005051206/http://cantorsattic.info/Upper_attic)
-   <div id="n-Middle-attic">

    </div>

    [Middle
    attic](/web/20191005051206/http://cantorsattic.info/Middle_attic)
-   <div id="n-Lower-attic">

    </div>

    [Lower
    attic](/web/20191005051206/http://cantorsattic.info/Lower_attic)
-   <div id="n-">
...
-   <div id="n-The-parlour">
    ...
    [The parlour](/web/20191005051206/http://cantorsattic.info/Parlour)
...
-   <div id="n-The-playroom">
    ...
    [The
    playroom](/web/20191005051206/http://cantorsattic.info/Playroom)
-   <div id="n-The-library">

    </div>

    [The library](/web/20191005051206/http://cantorsattic.info/Library)
-   <div id="n-The-cellar">

    </div>

    [The cellar](/web/20191005051206/http://cantorsattic.info/Cellar)
...
-   <div id="n-portal">
    ...
    [Community
    portal](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic:Community_portal "About the project, what you can do, where to find things")
-   <div id="n-currentevents">

    </div>

    [Current
    events](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic:Current_events "Find background information on current events")
-   <div id="n-recentchanges">

    </div>

    [Recent
    changes](/web/20191005051206/http://cantorsattic.info/Special:RecentChanges "A list of recent changes in the wiki [r]")
-   <div id="n-randompage">

    </div>

    [Random
    page](/web/20191005051206/http://cantorsattic.info/Special:Random "Load a random page [x]")
-   <div id="n-help">

    </div>

    [Help](http://web.archive.org/web/20191005051206/https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Contents "The place to find out")
...
-   <div id="t-whatlinkshere">
    ...
    [What links
    here](/web/20191005051206/http://cantorsattic.info/Special:WhatLinksHere/Cardinal "A list of all wiki pages that link here [j]")
-   <div id="t-recentchangeslinked">

    </div>

    [Related
    changes](/web/20191005051206/http://cantorsattic.info/Special:RecentChangesLinked/Cardinal "Recent changes in pages linked from this page [k]")
-   <div id="t-specialpages">

    </div>

    [Special
    pages](/web/20191005051206/http://cantorsattic.info/Special:SpecialPages "A list of all special pages [q]")
-   <div id="t-print">

    </div>

    [Printable
    version](/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&printable=yes "Printable version of this page [p]")
-   <div id="t-permalink">

    </div>

    [Permanent
    link](/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&oldid=2475 "Permanent link to this revision of the page")
-   <div id="t-info">

    </div>

    [Page
    information](/web/20191005051206/http://cantorsattic.info/index.php?title=Cardinal&action=info)
...
-   <div id="footer-info-viewcount">
    ...
    This page has been accessed 30,033 times.
...
-   <div id="footer-places-privacy">
    ...
    [Privacy
    policy](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic:Privacy_policy "Cantor's Attic:Privacy policy")
-   <div id="footer-places-about">

    </div>

    [About Cantor's
    Attic](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic:About "Cantor's Attic:About")
-   <div id="footer-places-disclaimer">

    </div>

    [Disclaimers](/web/20191005051206/http://cantorsattic.info/Cantor%27s_Attic:General_disclaimer "Cantor's Attic:General disclaimer")
...
-   <div id="footer-poweredbyico">
    ...
    [![Powered by
    MediaWiki](/web/20191005051206im_/http://cantorsattic.info/resources/assets/poweredby_mediawiki_88x31.png){width="88"
    height="31"}](//web.archive.org/web/20191005051206/http://www.mediawiki.org/)
