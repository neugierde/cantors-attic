...
dagger](/index.php?title=Zero_dagger&redirect=no "Zero dagger"))
...
[$\\text{ZFC+}$](/ZFC "ZFC")<a href="/web/20191005075509/http://cantorsattic.info/GCH" class="mw-redirect" title="GCH">$\text{GCH}$</a>
