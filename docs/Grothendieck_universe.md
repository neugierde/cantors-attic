...
universe](/web/20171207132830/http://cantorsattic.info/index.php?title=Grothendieck_universe&redirect=no "Grothendieck universe"))
...
[worldly](/web/20171207132830/http://cantorsattic.info/Worldly "Worldly")
...
[uncountable](/web/20171207132830/http://cantorsattic.info/Uncountable "Uncountable"){.mw-redirect}
[regular](/web/20171207132830/http://cantorsattic.info/Regular "Regular"){.mw-redirect}
[strong
limit](/web/20171207132830/http://cantorsattic.info/Strong_limit "Strong limit"){.mw-redirect}
cardinal.
...
-   Every inaccessible cardinal \$\\kappa\$ is an [aleph fixed
    point](/web/20171207132830/http://cantorsattic.info/Aleph_fixed_point "Aleph fixed point"){.mw-redirect}
    and a [beth fixed
    point](/web/20171207132830/http://cantorsattic.info/Beth_fixed_point "Beth fixed point"){.mw-redirect},
...
-   The uncountable [Grothedieck
    universes](/web/20171207132830/http://cantorsattic.info/Inaccessible#Grothendieck_universe "Inaccessible")
    are precisely the sets of the form \$V\_\\kappa\$ for an
    inaccessible cardinal \$\\kappa\$.
-   The [universe
    axiom](/web/20171207132830/http://cantorsattic.info/Inaccessible#universe_axiom "Inaccessible")
    is equivalent to the assertion that there is a proper class of
    inaccessible cardinals.
-   The inaccessible cardinals are precisely the
    [\$\\Pi\_0\^1\$-Indescribable](/web/20171207132830/http://cantorsattic.info/Indescribable "Indescribable")
...
[uncountable](/web/20171207132830/http://cantorsattic.info/Uncountable "Uncountable"){.mw-redirect}
[regular](/web/20171207132830/http://cantorsattic.info/Regular "Regular"){.mw-redirect}
[limit](/web/20171207132830/http://cantorsattic.info/index.php?title=Limit&action=edit&redlink=1 "Limit (page does not exist)"){.new}
cardinal. Under the
[GCH](/web/20171207132830/http://cantorsattic.info/GCH "GCH"){.mw-redirect},
...
paradox](/web/20171207132830/http://cantorsattic.info/Russell%27s_paradox "Russell's paradox").
...
\$\\kappa\$ is either
[\$0\$](/web/20171207132830/http://cantorsattic.info/Zero "Zero"),
[\$\\omega\$](/web/20171207132830/http://cantorsattic.info/Omega "Omega")
...
Every
[Mahlo](/web/20171207132830/http://cantorsattic.info/Mahlo "Mahlo")
...
Retrieved from
"[http://cantorsattic.info/index.php?title=Inaccessible&oldid=1710\#universes](http://web.archive.org/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&oldid=1710#universes)"
...
-   <div id="pt-createaccount">
    ...
    [Create
    account](/web/20171207132830/http://cantorsattic.info/index.php?title=Special:UserLogin&returnto=Inaccessible&type=signup)
-   <div id="pt-login">

    </div>

    [Log
    in](/web/20171207132830/http://cantorsattic.info/index.php?title=Special:UserLogin&returnto=Inaccessible "You are encouraged to log in; however, it is not mandatory [o]")
...
-   <div id="ca-nstab-main">
    ...
    [[Page](/web/20171207132830/http://cantorsattic.info/Inaccessible "View the content page [c]")]{}
-   <div id="ca-talk">

    </div>

    [[Discussion](/web/20171207132830/http://cantorsattic.info/index.php?title=Talk:Inaccessible&action=edit&redlink=1 "Discussion about the content page [t]")]{}
...
-   <div id="ca-view">
    ...
    [[Read](/web/20171207132830/http://cantorsattic.info/Inaccessible)]{}
-   <div id="ca-viewsource">

    </div>

    [[View
    source](/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&action=edit "This page is protected.
...
-   <div id="ca-history">
    ...
    [[View
    history](/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&action=history "Past revisions of this page [h]")]{}
...
[](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic "Visit the main page")
...
-   <div id="n-Upper-attic">
    ...
    [Upper
    attic](/web/20171207132830/http://cantorsattic.info/Upper_attic)
-   <div id="n-Middle-attic">

    </div>

    [Middle
    attic](/web/20171207132830/http://cantorsattic.info/Middle_attic)
-   <div id="n-Lower-attic">

    </div>

    [Lower
    attic](/web/20171207132830/http://cantorsattic.info/Lower_attic)
-   <div id="n-">
...
-   <div id="n-The-parlour">
    ...
    [The parlour](/web/20171207132830/http://cantorsattic.info/Parlour)
...
-   <div id="n-The-playroom">
    ...
    [The
    playroom](/web/20171207132830/http://cantorsattic.info/Playroom)
-   <div id="n-The-library">

    </div>

    [The library](/web/20171207132830/http://cantorsattic.info/Library)
-   <div id="n-The-cellar">

    </div>

    [The cellar](/web/20171207132830/http://cantorsattic.info/Cellar)
...
-   <div id="n-portal">
    ...
    [Community
    portal](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic:Community_portal "About the project, what you can do, where to find things")
-   <div id="n-currentevents">

    </div>

    [Current
    events](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic:Current_events "Find background information on current events")
-   <div id="n-recentchanges">

    </div>

    [Recent
    changes](/web/20171207132830/http://cantorsattic.info/Special:RecentChanges "A list of recent changes in the wiki [r]")
-   <div id="n-randompage">

    </div>

    [Random
    page](/web/20171207132830/http://cantorsattic.info/Special:Random "Load a random page [x]")
-   <div id="n-help">

    </div>

    [Help](http://web.archive.org/web/20171207132830/https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Contents "The place to find out")
...
-   <div id="t-whatlinkshere">
    ...
    [What links
    here](/web/20171207132830/http://cantorsattic.info/Special:WhatLinksHere/Inaccessible "A list of all wiki pages that link here [j]")
-   <div id="t-recentchangeslinked">

    </div>

    [Related
    changes](/web/20171207132830/http://cantorsattic.info/Special:RecentChangesLinked/Inaccessible "Recent changes in pages linked from this page [k]")
-   <div id="t-specialpages">

    </div>

    [Special
    pages](/web/20171207132830/http://cantorsattic.info/Special:SpecialPages "A list of all special pages [q]")
-   <div id="t-print">

    </div>

    [Printable
    version](/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&printable=yes "Printable version of this page [p]")
-   <div id="t-permalink">

    </div>

    [Permanent
    link](/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&oldid=1710 "Permanent link to this revision of the page")
-   <div id="t-info">

    </div>

    [Page
    information](/web/20171207132830/http://cantorsattic.info/index.php?title=Inaccessible&action=info)
...
-   <div id="footer-info-viewcount">
    ...
    This page has been accessed 25,541 times.
...
-   <div id="footer-places-privacy">
    ...
    [Privacy
    policy](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic:Privacy_policy "Cantor's Attic:Privacy policy")
-   <div id="footer-places-about">

    </div>

    [About Cantor's
    Attic](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic:About "Cantor's Attic:About")
-   <div id="footer-places-disclaimer">

    </div>

    [Disclaimers](/web/20171207132830/http://cantorsattic.info/Cantor%27s_Attic:General_disclaimer "Cantor's Attic:General disclaimer")
...
-   <div id="footer-poweredbyico">
    ...
    [![Powered by
    MediaWiki](/web/20171207132830im_/http://cantorsattic.info/resources/assets/poweredby_mediawiki_88x31.png){width="88"
    height="31"}](//web.archive.org/web/20171207132830/http://www.mediawiki.org/)
